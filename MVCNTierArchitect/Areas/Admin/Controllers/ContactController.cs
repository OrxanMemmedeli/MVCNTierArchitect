...
namespace MVCNTierArchitect.Areas.Admin.Controllers
{
    public class ContactController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,UserName,Email,Subject,Message")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,UserName,Email,Subject,Message")] Contact contact)
        {
            if (ModelState.IsValid)
            {
